...
export default function DiscoverPage() {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', height: '100dvh', overflow: 'hidden' }}>
      ...
      <div style={{ flex: 1, overflowY: 'auto', display: 'flex', flexDirection: 'column', maxWidth: '1020px', margin: '0 auto', width: '100%', scrollbarWidth: 'none', msOverflowStyle: 'none', paddingTop: '50px' }}>
        <style>{`

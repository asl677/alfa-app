...
export default function ChatPage() {
  ...
  return (
    <div style={{
      ...
      <div ref={messagesContainerRef} style={{ flex: 1, overflowY: 'auto', display: 'flex', flexDirection: 'column', gap: 0, padding: '12px 20px 180px', maxWidth: '1020px', margin: '0 auto', width: '100%', position: 'relative', boxSizing: 'border-box', maskImage: 'linear-gradient(180deg, black 0%, black 80%, transparent 100%)', WebkitMaskImage: 'linear-gradient(180deg, black 0%, black 80%, transparent 100%)' }}>

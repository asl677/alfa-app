...
const STOCK_POOLS = {
  ashley: [
    ...
    { symbol: 'GOOGL', name: 'Alphabet Inc.', tracked: false },
    { symbol: 'META', name: 'Meta Platforms', tracked: true },
    { symbol: 'AMZN', name: 'Amazon.com Inc.', tracked: false },
    { symbol: 'AMD', name: 'Advanced Micro Devices', tracked: true },
    { symbol: 'AVGO', name: 'Broadcom Inc.', tracked: false },
    { symbol: 'INTC', name: 'Intel Corp.', tracked: true },
  ],
  mike: [
    ...
    { symbol: 'WMT', name: 'Walmart Inc.', tracked: false },
    { symbol: 'XOM', name: 'Exxon Mobil Corp.', tracked: true },
    { symbol: 'CVX', name: 'Chevron Corp.', tracked: false },
    { symbol: 'MCD', name: 'McDonald\'s Corp.', tracked: true },
    { symbol: 'BA', name: 'Boeing Co.', tracked: false },
    { symbol: 'GE', name: 'General Electric', tracked: true },
  ],
  tom: [
    ...
    { symbol: 'HES', name: 'Hess Corp.', tracked: false },
    { symbol: 'EOG', name: 'EOG Resources', tracked: true },
    { symbol: 'SLB', name: 'Schlumberger Ltd.', tracked: false },
    { symbol: 'FANG', name: 'Diamondback Energy', tracked: true },
    { symbol: 'MRO', name: 'Marathon Oil Corp.', tracked: false },
    { symbol: 'HAL', name: 'Halliburton Co.', tracked: true },
  ],
}
